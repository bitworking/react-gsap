...
| wrapper? | any | This component gets wrapped around the Timeline component |
| target? | any | The target component that gets outputted and tweened from all childless Tween child components |
